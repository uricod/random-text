...
class Faker:
    ...
    def __init__(self):
        self.BASE_URL = f'https://fakerapi.it/api/v1/'

    def make_request(self, url, method, locale='en_US', quantity=5, other_parameters={}, seed='null', body=None):
        header = {'Accept': 'application/json'}
        parameters = {'_locale': locale, '_quantity': quantity, '_seed': seed}
